...
export const mockPaymentStudents = [
  {
    id: '1',
    name: 'Eda Erdem',
...
export const mockPaymentDetails = {
  '1': {
    id: '1',
    name: 'Eda Erdem',
    photo: '/avatars/profile-large.svg',
    profile: {
      tc: '10681408990',
      school: 'Youreye İlkokulu',
      dob: '19.11.2001',
      grade: '2F',
      phone: '542 661 62 22',
      branch: 'Orta Oyuncu',
      address: 'Ahi Mesut Mahallesi Bahçen Elvanşehir Konutları I Blok No:18 Etimesgut / Ankara'
    },
    payments: [
      {
